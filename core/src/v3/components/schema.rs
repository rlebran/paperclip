...
pub enum SchemaKind {
    ...
    OneOf {
        #[serde(rename = "oneOf")]
        one_of: Vec<Either<Reference, Schema>>,
    },
    AllOf {
        #[serde(rename = "allOf")]
        all_of: Vec<Either<Reference, Schema>>,
    },
    AnyOf {
        #[serde(rename = "anyOf")]
        any_of: Vec<Either<Reference, Schema>>,
    },
    Not {
        not: Box<Either<Reference, Schema>>,
    },
    Any(AnySchema),
}
...
pub enum AdditionalProperties {
    Any(bool),
    Schema(Box<Either<Reference, Schema>>),
}
...
pub struct AnySchema {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub one_of: Vec<Either<Reference, Schema>>,
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub all_of: Vec<Either<Reference, Schema>>,
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub any_of: Vec<Either<Reference, Schema>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub not: Option<Box<Either<Reference, Schema>>>,
}
